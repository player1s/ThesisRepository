...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\mindenJoSHasztalan\\UniversityAndStuff\\DTU\\Semester 6\\Thesis\\Code\\ThesisRepository\\psychopyExperiments\\oddballV2\\Oddball TaskV2_lastrun.py',
...
instructions = visual.TextStim(win=win, name='instructions',
    text="In this task you will be required to categorise the presented stimuli depending on the tone. Count the odd tone. Press 'space' to continue. Press 'esc' to exit the experiment.",
    font='Arial',
...
instructions_2 = visual.TextStim(win=win, name='instructions_2',
    text="Got it? Press 'space' to continue.",
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial in trials:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_1.setSound(tone, secs=0.5, hamming=True)
    sound_1.setVolume(1.0, log=False)
    # Run 'Begin Routine' code from code_2
    if corrAns == "t":
        outlet.push_sample(x=[startTarget])
    else: 
        outlet.push_sample(x=[startStandard])
    # keep track of which components have finished
    TrialComponents = [fixation, sound_1]
